"""
store.py - Conversation Store Module

This module implements PY-001.12 from the osmPhone architecture.
It provides a SQLite-backed persistent storage for text messages
between the user's phone and their contacts. This allows the backend
to maintain conversational history for the LLM to contextually respond
